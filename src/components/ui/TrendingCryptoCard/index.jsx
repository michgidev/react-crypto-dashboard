...
const renderCryptoTrendData = ({item}) => {
  return( 
    <div className="px-2 py-3 flex items-center 
      justify-between border-t border-gray-300 dark:border-slate-700" key={item.name}>
...
const TrendingCryptoCard = () => {
  ...
  return(
    <div className="w-full h-[auto] px-4 pb-4 bg-white rounded-2xl shadow-md shadow-indigo-100 
      ...
      {trendingCryptoData && trendingCryptoData?.coins?.map((item) => renderCryptoTrendData(item))}
