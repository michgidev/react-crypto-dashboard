        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2.5 items-center">
            ...
            <div className="flex items-baseline">
              ...
              <span className="text-sm text-white leading-none ms-2 py-0.5 
                px-2 rounded-2xl bg-violet-500 self-baseline">
        ...
        <div className="flex flex-1 items-center justify-between py-4 border-y 
          ...
          <div className="p-0 flex-col items-center justify-center gap-2 
            ...
            <div className="flex gap-1 items-end justify-center">
              <ArrowIcon value={data.data?.price_change_percentage_24h?.usd} />

              <p className="text-2xl text-center font-black dark:text-gray-100">
                {formatPercentage(data.data?.price_change_percentage_24h?.usd)}
              </p>
            </div>
